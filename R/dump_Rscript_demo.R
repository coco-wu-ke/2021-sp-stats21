...
51.5, 51, 77)), class = "data.frame", row.names = c(NA, -31L))
L <-
list(vector = 1:10, `data frame` = structure(list(Name = structure(c(2L, 
3L, 1L), .Label = c("April", "Leslie", "Ron"), class = "factor"), 
    Height = c(62, 71, 66), Weight = c(115, 201, 119), Income = c(4000, 
    NA, 2000)), class = "data.frame", row.names = c(NA, -3L)), 
    list = list(1:5, structure(1:9, .Dim = c(3L, 3L))))
